...
class ParkingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parking" do
    assert_difference("Parking.count") do
      post parkings_url, params: { parking: { description: @parking.description, name: @parking.name } }
    end
  ...
  test "should update parking" do
    patch parking_url(@parking), params: { parking: { description: @parking.description, name: @parking.name } }
